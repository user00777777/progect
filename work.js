...
switch (vital,stas,paha,vasj) {
   ...
   case  day2: if (hour>=19&&day2==vasj) out4.innerHTML=' Дежурный электрик<span id="vas"> Малько</span> <br> 2 смена <br>Деж. сантехник<span="vas"><span id="vas"> Ничипорчук А</span>';
