...
let Malko = ([] = changeAr(count(4, 0), count(4, 1)));
let Kruglui = ([] = changeAr(count(4, 1), count(4, 2)));
let PahaLusenko = ([] = changeAr(count(4, 3), count(4, 0)));
let Sinkevish = ([] = changeAr(count(4, 2), count(4, 3)));
